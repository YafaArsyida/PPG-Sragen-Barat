        ...
        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
            ...
            <div>
                <div class="d-flex align-items-center gap-2 mb-1">
                    ...
                    <div>
                        ...
                        <small>
                            Pengurus dengan kehadiran terbaik
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-shrink-0">
                <select wire:model="periode"
                    class="fw-bold form-select bg-primary-subtle text-primary rounded-pill shadow-sm border-light">
                    <option value="1bulan">
                        1 Bulan
                    </option>
                    <option value="3bulan">
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-xs flex-shrink-0">
                                    <div class="avatar-title {{ $item->ms_pengurus->jenis_kelamin == 'perempuan'
                                        ? 'bg-danger-subtle text-danger'
                                        : 'bg-primary-subtle text-primary' 
                                        }} 
                                        rounded-circle fw-semibold">
                                        {{ strtoupper(substr($item->ms_pengurus->nama_pengurus ?? 'G', 0, 1)) }}
                                    </div>
                                </div>
                                <div>
                                    <div class="fw-semibold text-body">
                                        {{ $item->ms_pengurus->nama_pengurus ?? '-' }}
                                    </div>
                                    <small>
                                        {{ $item->ms_pengurus->ms_kelompok->nama_kelompok ?? '-' }}
                                    </small>
                                </div>
                            </div>
                        </td>
                        ...
                        <td colspan="4" class="text-center py-5">
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <p class="text-muted mb-0 fs-13">
                                    Ranking kehadiran Pengurus akan tampil di sini.
                                </p>
                            </div>
                        </td>
                    </tr>
