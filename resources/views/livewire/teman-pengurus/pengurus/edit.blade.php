<div wire:ignore.self class="modal fade" id="PengurusEdit" tabindex="-1" aria-labelledby="PengurusEditLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-header border-0 pb-0 pt-4 px-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="fw-bold mb-1" id="PengurusEditLabel">
                            Edit Pengurus
                        </h5>
                        <small>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="text" class="form-control" wire:model.defer="kode_pengurus"
                                    placeholder="Contoh : PNG001">
                                @error('kode_pengurus')
                                <small class="text-danger d-block mt-1">
                                    {{ $message }}
                                </small>
