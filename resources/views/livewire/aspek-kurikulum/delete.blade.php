<div wire:ignore.self class="modal fade" id="DeleteAspek" tabindex="-1" aria-labelledby="DeleteAspekLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="modal-body px-4 pb-5 pt-2 text-center">
                ...
                <div class="mb-2">
                    ...
                    <h3 class="fw-bold mb-2" id="DeleteAspekLabel">
                        Hapus Aspek Kurikulum?
                    </h3>
                    <p class="text-muted mb-0 lh-lg px-lg-4">
                        ...
                        akan dihapus dari sistem kurikulum generus. Tindakan ini tidak dapat dibatalkan.
                    </p>
                </div>
                {{-- WARNING --}}
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 fs-13">
                                Pastikan aspek tidak memiliki materi aktif sebelum melakukan penghapusan.
                            </p>
                        </div>
                    </div>
                </div>
