<div wire:ignore.self class="modal fade" id="AspekCreate" tabindex="-1" aria-labelledby="AspekCreateLabel"
    aria-hidden="true">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            Tambahkan aspek pembinaan generus pada kurikulum
                        </small>
                    </div>
                </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <small class="text-muted mt-1 d-block">
                                    Gunakan nama aspek yang jelas dan mudah dipahami pengurus kelompok
                                </small>
                                @error('nama_aspek')
