<div wire:ignore.self class="modal fade" id="PeriodeCreate" tabindex="-1" aria-labelledby="PeriodeCreateLabel"
    aria-hidden="true">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="fw-bold mb-1">
                            Tambah Periode Kurikulum
                        </h5>
                        <small class="text-muted">
                            Tentukan periode pelaksanaan kurikulum generus
                        </small>
                    </div>
                </div>
