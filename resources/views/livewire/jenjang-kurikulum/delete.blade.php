<div wire:ignore.self class="modal fade" id="JenjangDelete" tabindex="-1" aria-labelledby="deleteRecordLabel"
    aria-hidden="true">
            ...
            <div class="modal-body px-4 pb-5 pt-2 text-center">
                ...
                <div class="mb-2">
                    ...
                    <h3 class="fw-bold mb-2" id="deleteRecordLabel">
                        Hapus Jenjang Kurikulum?
                    </h3>
                    <p class="text-muted mb-0 lh-lg px-lg-4">
                        Data jenjang akan dihapus secara permanen dari sistem dan tidak dapat
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 fs-13">
                                Pastikan jenjang tidak memiliki data aspek, materi, maupun laporan kurikulum
